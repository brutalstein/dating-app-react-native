            ...
            <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} className="flex-1">
                <View className="flex-1 px-6 pt-16">
                    ...
                    <View className="items-center mb-10">
                        ...
                        <Text className="text-zinc-300 text-center text-base mb-1">
                            6 haneli kodu gönderdik
                        </Text>
                            ...
                            {canResend ? (
                                <TouchableOpacity onPress={handleResend}>
                                    <Text className="text-zinc-300 text-base">
                                        Kod gelmedi mi?{' '}
                                        <Text className="text-[#FF5A5F] font-bold underline">Yeniden Gönder</Text>
                                    </Text>
                                </TouchableOpacity>
                            ) : (
                                <Text className="text-zinc-400 text-base">
                                    Yeniden gönder:{' '}
                                    <Text className="text-white font-semibold">{formatTime(countdown)}</Text>
                                </Text>
                            )}
                        </View>
                    </Animated.View>
